...
<html lang="en">
  ...
  <head>
    ...
    <title>News Live | Home Page</title>
...
$query=mysqli_query($con,"select item_title as posttitle,item_desc as news_details,item_date as postingdate,item_id as pid,item_category as category ,image as PostImage from  (select * from news_bussiness UNION select * from news_politics UNION select * from news_sports UNION select * from news_movies )as mix order by item_date desc  LIMIT $offset, $no_of_records_per_page");
  echo "<center><b><h1>Latest News</h1></b></center>";
