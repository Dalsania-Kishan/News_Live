...
$feed_url='https://www.news18.com/rss/politics.xml';
try
{
	/*  query the database */
	// $db = getCon();
...
//		die("Could not connect: " . mysqli_error());
	...
	foreach($RSS_DOC->channel->item as $RSSitem)
	{
		...
		$item_exists_sql = "SELECT item_id FROM news_politics where item_id = '" . $item_id . "'";
		...
		//	echo $result[0];
			...
			$item_insert_sql = "INSERT INTO news_politics(item_id,  item_title,feed_url, item_date, item_url,item_desc,fetch_date, item_category,image) VALUES ('  $item_id ', ' $item_title ',' $feed_url', ' $item_date', ' $item_url', ' $item_desc', ' $fetch_date ' ,' $item_category 	','$src')";
